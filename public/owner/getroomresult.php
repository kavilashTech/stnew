...
$sql = "select A.name as Amenity, B.name as Amenity_List, C.value as value, C.valuecontent as valuecontent from amenities A, amenities_list B, room_amenities C
