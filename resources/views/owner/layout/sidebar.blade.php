        ...
        <nav class="sb-sidenav accordion thm-bg" id="sidenavAccordion">
            <div class="sb-sidenav-menu">
                <div class="nav">
                    ...
                    <a class="nav-link" href="{{route('owner.room.roomvacancyupdate',['id'=>'1'])}}">
                        <div class="sb-nav-link-icon"><i class="fa   fa-tachometer-alt"></i></div>
                        Room vacancy
                    </a>
                    <a class="nav-link" href="{{route('owner.staytype.edit',['staytype'=>'1'])}}">
                        <div class="sb-nav-link-icon"><i class="fa   fa-tachometer-alt"></i></div>
                       Staytype Edit
                    </a>
                    ...
                    <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                        <nav class="sb-sidenav-menu-nested nav">
                            <a class="nav-link" href="#">Staytype Categories</a>
